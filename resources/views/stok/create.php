<?php $pageTitle = 'Tambah Stok'; ?>
<div class="page-header">
    <a href="/stok" class="btn btn-sm btn-outline-secondary mb-2"><i class="bi bi-arrow-left me-1"></i>Kembali</a>
    <h4><i class="bi bi-plus-circle me-2" style="color:var(--accent)"></i>Tambah Stok Bahan Baku</h4>
</div>
        ...
        <form method="POST" action="/stok">
            <div class="row">
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" name="nama_bahan" class="form-control" placeholder="Contoh: Beras" required>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="jumlah" class="form-control" placeholder="0" min="0" step="0.01">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label fw-semibold">Stok Minimum</label>
                    <input type="number" name="stok_minimum" class="form-control" placeholder="0" min="0" step="0.01">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label fw-semibold">Harga/Satuan (Rp)</label>
                    <input type="number" name="harga_satuan" class="form-control" placeholder="0" min="0">
                </div>
            </div>
            <div class="mb-4">
